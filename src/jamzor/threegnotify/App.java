...
public class App extends Application {
    public ICheckerService checker;
    ...
    private ServiceConnection mServiceConnection = new ServiceConnection() {
        ...
        public void onServiceConnected(ComponentName name, IBinder service) {
            // Get our interface...
            checker = ICheckerService.Stub.asInterface(service);
        }
    ...
    public void onCreate() {
        ...
        /*
         * Check if they just upgraded from < 2.0, if that's the case we need to update our
         * preferences, because types changed.
         */
        try {
